# Contributing to communikey

Thanks for contributing to communikey!

This is a set of guidelines for contributing to communikey. Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.
...
communikey is an open source project and we love to receive contributions from the community! There are many ways to contribute, from [writing- and improving documentation and tutorials](#documentations), [reporting bugs](#bug-reports), [submitting enhancement suggestions](#enhancement-suggestions) which can be incorporated into communikey itself by [submitting a pull request](#pull-requests).
...
communikey is a open source project which is [split up into multiple repositories][gh-profile-repo-search-communikey] and is intentionally very modular. Each project lives in its own repository.

**Please make sure to determine the correct repository before you continue!**

Contributions related to [communikey frontend][gh-communikey-frontend] belong to the specific repository while contributions related to the communikey backend (API) itself are welcome in this repository. This helps all core team members, committers and maintainer in this project to process every contribution faster without organization overhead.
...
* **Did the problem start happening recently** e.g. after updating to a new version of communikey or was this always a problem?
  * If the problem started happening recently, **can you reproduce the problem in an older version of communikey?**
...
Please include details about your configuration and environment based on the [issue template][template-issue].
...
* **Explain why this enhancement would be useful** to most communikey users.
...
* **Make sure to follow the [Java Checkstyle](#java-code-style) and [Git commit message](#git-commit-messages) style guides**.
...
communikey's documentation consists of guides, which helps users to learn about the project, and the project docs, which serves as a reference.
...
communikey uses the [gitflow][gitflow] branching model. The repository consists of two core branches with an infinite development lifecycle:
...
We're always looking for more opinions on discussions in issues and pull request reviews which is a good opportunity to influence the future direction of communikey.

The [type-question][gh-issues-label-question] issue label is a good place to find ongoing discussions and questions.
...
communikey adheres to the communicode Code Style 1.1 which is enforced through [Checkstyle][].
...
There are many guides and articles like e.g. the [Arctic Ice Studio Git Style Guide][styleguide-git-github]. The style guide assumes that you are familiar with the [gitflow][gitflow] branching model.
...
[branch-develop]: https://github.com/communicode/communikey-backend/tree/develop
...
[gh-issues]: https://github.com/communicode/communikey-backend/issues
[gh-issues-label-question]: https://github.com/communicode/communikey-backend/labels/type-question
[gh-pr]: https://github.com/communicode/communikey-backend/pulls
[gh-profile-repo-search-communikey]: https://github.com/communicode?q=communikey
...
[template-issue]: https://github.com/communicode/communikey-backend/blob/develop/.github/ISSUE_TEMPLATE.md
[template-pr]: https://github.com/communicode/communikey-backend/blob/develop/.github/PULL_REQUEST_TEMPLATE.md
[version-latest]: https://github.com/communicode/communikey-backend/releases/latest
